...
# /home/atr/WMJ/bowl2/maskrcnn_benchmark/modeling/roi_heads/mask_head/inference.py
...
class Masker(object):
    ...
    def forward_single_image(self, masks, boxes):
        ...
        x = paste_mask_in_image(masks[0][0],boxes.bbox[0],im_h,im_w, self.threshold, self.padding)
        res = [
